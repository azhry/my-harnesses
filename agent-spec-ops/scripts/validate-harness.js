...
const requiredFiles = [
  ...
  "scripts/audit-codex-sessions.js",
  "scripts/record-completion-approval.js",
  "scripts/record-git-policy.js",
  "scripts/record-run-directives.js",
  "scripts/record-run-secrets.js",
