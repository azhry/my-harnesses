...
$Script:INFRA_FILE = Join-Path (Join-Path $ROOT_DIR "docs") "infrastructure.md"
$Script:DEPLOY_STATE_FILE = Join-Path (Join-Path $ROOT_DIR "state") "current-deployment.json"
